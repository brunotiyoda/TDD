...
public class LeilaoTest {
	...
	public void deveReceberVariosLances() {
		...
		leilao.propoe(new Lance(new Usuario("Estive Jóbes"), 20000));
		leilao.propoe(new Lance(new Usuario("Pou Marcartener"), 15000));
		
		assertEquals(2, leilao.getLances().size());
		assertEquals(20000.0, leilao.getLances().get(0).getValor(), 0.00001);
		assertEquals(15000.0, leilao.getLances().get(1).getValor(), 0.00001);
	}
	
	@Test
	public void naoDeveAceitarDoisLancesSeguidosDoMesmoUsuario() {
		Leilao leilao =  new Leilao("Macbook Pro UltraPower");
